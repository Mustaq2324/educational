...
const ShuffleHero = () => {
  return (
    <section className="w-full px-4 md:px-8 py-8 md:py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto">
    <div>
      <span className="block mb-4 text-xs md:text-sm text-indigo-400 font-medium">
        Better every day
      </span>
      <h3 className="text-2xl md:text-4xl lg:text-6xl font-semibold">
        Let's change it up a bit
      </h3>
      <p className="text-base md:text-lg lg:text-xl text-slate-700 my-4 md:my-6">
